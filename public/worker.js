//------------------- algorithm-visualizer.umd.js (js代码提取器)--------------------------
...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var Array2DTracer = /** @class */ (function (_super) {
      ...
      Array2DTracer.prototype.setColor = function (color, sx, sy, ex, ey) {
          this.command('setColor', arguments);
      };

      Array2DTracer.prototype.setRowColor = function (color, x, sy, ey) {
          this.command('setRowColor', arguments);
      };

      Array2DTracer.prototype.setColColor = function (color, y, sx, ex) {
          this.command('setColColor', arguments);
      };

      Array2DTracer.prototype.removeColor = function (sx, sy, ex, ey) {
          this.command('removeColor', arguments);
      };

      Array2DTracer.prototype.removeRowColor = function (x, sy, ey) {
          this.command('removeRowColor', arguments);
      };

      Array2DTracer.prototype.removeColColor = function (y, sx, ex) {
          this.command('removeColColor', arguments);
      };
  ...
  var Array1DTracer = /** @class */ (function (_super) {
      ...
      Array1DTracer.prototype.setColor = function (color, sx, ex) {
          this.command('setColor', arguments);
      };

      Array1DTracer.prototype.removeColor = function (sx, ex) {
          this.command('removeColor', arguments);
      };
